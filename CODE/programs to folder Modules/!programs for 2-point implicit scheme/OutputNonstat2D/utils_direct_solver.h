...
int ReadDecadeInfoTimeAll(int ntime,double *time,int &nDec,vector<int> &DecIg,int &tbeg,int &tend,char *path);
int FindTimeLayersForDec(int ntime,double *time,vector<int> &DecIg,int &tbeg,int &tend);
