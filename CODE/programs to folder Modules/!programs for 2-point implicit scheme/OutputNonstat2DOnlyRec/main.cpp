 ...
 *  
 *  			TDEMLineCalc
 *  This file contains code for outputting nonstationary 2D two-layer scheme task results
 *  
 *  
...
int main(int argc,char **argv)
{
	...
	if(fExists3D)
	{
		system("copy xyzVectorE0 xyzVectorE0_tmp");
		system("del /q xyzVectorE0");
		Sleep(500);
	...
	system("rmdir /s /q Ax");
	system("rmdir /s /q Ar");
	system("rmdir /s /q Hfi");

	if(fExists3D)
	{
		system("del /q xyzVectorE0");
		Sleep(500);
		system("copy xyzVectorE0_tmp xyzVectorE0");
		system("del /q xyzVectorE0_tmp");
	}
