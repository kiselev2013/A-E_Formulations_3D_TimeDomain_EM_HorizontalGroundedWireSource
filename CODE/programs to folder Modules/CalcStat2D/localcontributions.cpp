...
/*!  (dPi/dz)*(dPj/dz)   rz  1/r^2 */
int GetStiffnessMatrix0Dz(const double &r0, const double &z0, // coordinates of local node 2
					   const double &r3, const double &z3, // coordinates of local node 1
					   double m[4][4])
{
...
/*!  (dPi/dr)*(dPj/dr)   rz  1/r^2 */
int GetStiffnessMatrix0Dr(const double &r0, const double &z0, // coordinates of local node 2
					   const double &r3, const double &z3, // coordinates of local node 1
					   double m[4][4])
{
	...
	m[2][2]=		(1./h1)*(rk+h1/2)*z11;
	m[2][3]=m[3][2]=-(1./h1)*(rk+h1/2)*z11;
	m[2][0]=m[0][2]=(1./h1)*(rk+h1/2)*z12;
	m[2][1]=m[1][2]=-(1./h1)*(rk+h1/2)*z12;

	m[3][3]=		(1./h1)*(rk+h1/2)*z11;
	m[3][0]=m[0][3]=-(1./h1)*(rk+h1/2)*z12;
	m[3][1]=m[1][3]=(1./h1)*(rk+h1/2)*z12;

	m[0][0]=		(1./h1)*(rk+h1/2)*z22;
	m[0][1]=m[1][0]=-(1./h1)*(rk+h1/2)*z22;

	m[1][1]=		(1./h1)*(rk+h1/2)*z22;
