 ...
 *  
 *  			TDEMLineCalc
 *  This file contains the code for calculation of secondary part of field V for stationary task
 *  
 *  
...
int SolveStationarProblem3d(const char* path,bool f3d)
{
	ifstream inf;
	char buf[256];
